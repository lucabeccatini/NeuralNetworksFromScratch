...
if (test_1==True):
    ...
    s_pred = model_s.n
    model_s.fit(X_train=X_train[[3]], Y_train=Y_train[[3]], X_val=X_train[[3]], Y_val=Y_train[[3]], epochs=1, batch_size=1, learn_rate=0.001)
...
if (test_2==True):
    ...
    # training NNFS
    model_s.fit(X_train=X_train, Y_train=Y_train, X_val=X_val, Y_val=Y_val, epochs=100, batch_size=100, patience=10, min_improvement=0)
    ...
    #fig.show()
    fig.savefig("/home/lb_linux/NeuralNetworksFromScratch/PlotMoons_layers{}x{}x{}_seed{}.pdf".format(layers[0], layers[1], layers[2], seed_all))
